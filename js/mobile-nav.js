...
mobileNavBtnOpen.addEventListener('click', function() {
    ...
    // Также добавлен класс no-scroll к тегу body чтобы запретить скролл на странице
    document.body.classList.add('no-scroll');
});

// Вешаем прослушку по клику на кнопку Закрытия мобильной навигации
mobileNavBtnClose.addEventListener('click', function() {
    // По клику удаляем класс mobile-nav--open к блоку с мобильной навигацией
    mobileNav.classList.remove('mobile-nav--open');

    // Удаляем класс no-scroll к тегу body чтобы включить скролл на странице
